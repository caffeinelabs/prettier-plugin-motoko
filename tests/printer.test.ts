...
const LAYOUT: Case[] = [
    ...
    },
    {
        source: 'let x = aaaa\n  + bbbb\n  + cccc;',
        printed: 'let x = aaaa\n  + bbbb\n  + cccc;\n',
        why: 'a chain broken before its operators stays broken there',
    },
];
...
const COMMENTS: Case[] = [
    {
        source: 'let a = [\n  /* first */ 1,\n  2\n];',
        printed: 'let a = [\n  /* first */ 1,\n  2\n];\n',
        why: 'a block comment before an item stays on its line',
    },
    {
        source: 'let x = 1; // hi\nlet y = 2',
        printed: 'let x = 1; // hi\nlet y = 2\n',
...
const BLANK_LINES: Case[] = [
    ...
    },
    {
        source: 'switch x {\n\n  case 1 {}\n\n\n  case _ {}\n\n}',
        printed: 'switch x {\n\n  case 1 {}\n\n  case _ {}\n\n}\n',
        why: 'so are blank lines at the edges of a switch and between its arms',
    },
];
